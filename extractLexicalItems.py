...
adjFile = open('./logical_forms/Hagar/adj_lfs', "w")
detFile = open('./logical_forms/Hagar/det_lfs', "w")
nounFile = open('./logical_forms/Hagar/noun_lfs', "w")
prepFile = open('./logical_forms/Hagar/prep_lfs', "w")
verbFile = open('./logical_forms/Hagar/verb_logical_forms', "w")
...
for i in range(1, 135):
    for line in open('./trainFiles/trainPairs.hagar.ready_{}'.format(str(i)), "r"):
